...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        type guards function.  ``TypeGuard`` only accepts a single type argument.
        ...
        conditional expression here is sometimes referred to as a "type guards".

        Sometimes it would be convenient to use a user-defined boolean function
        as a type guards.  Such a function should use ``TypeGuard[...]`` as its
